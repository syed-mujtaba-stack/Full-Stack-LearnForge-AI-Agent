        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-muted-foreground mt-2">Start your journey to expertise today.</p>
                </div>
                ...
                <div className="bg-card border border-border p-8 rounded-[2.5rem] shadow-2xl glass">
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-card px-4 text-muted-foreground font-bold tracking-widest">Or join with</span>
                        </div>
                    </div>
                ...
                <p className="text-center mt-8 text-muted-foreground font-medium">
                    Already a learner? <Link href="/login" className="text-primary font-black hover:underline">Sign In</Link>
                </p>
            </motion.div>
        </div>
    );
